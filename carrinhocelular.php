...
<body>
	...
	<div class="container">
		...
		<?php if($resultsCarts) : ?>
				...
				<tbody>
				  <?php foreach($resultsCarts as $result) : ?>
					<tr>
						...
						<td><a href="carrinhocelular.php?acao=del&id=<?php echo $result['id']?>" class="btn btn-outline-success">Remover</a></td>
			...
			<a class="btn btn-outline-success" href="celular.php">Continuar Comprando</a>
